...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Get Member') }}</div>
                ...
                <div class="card-body">
                    ...
                    <form id="form-register">
                        ...
                        <div class="form-group row">
                            <label for="id" class="col-md-4 col-form-label text-md-right">{{ __('ID Member') }}</label>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="age" type="number" class="form-control @error('age') is-invalid @enderror" name="age" value="{{ old('age') }}" required autocomplete="age" readonly>
...
<script>
    ...
    $(".save-data").click(function(event){
        ...
        $.ajax({
          ...
          error:function(){
            $("input[name=name]").val('Not found');
            $("input[name=email]").val('Not found');
            $("input[name=city]").val('Not found');
